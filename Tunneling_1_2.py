...
for i in range(600):
    ...
    ims.append([square,t_label,wave_l,wave_c,wave_r])


 
ani = animation.ArtistAnimation(fig, ims, interval=20, repeat=False,blit=True)
##plt.show()
ani.save('Tunneling_1_2.mp4', writer='ffmpeg')